...
export const EXTENSIONS = {
  ...
  video: ['mp4', 'webm', 'mov', 'mkv', 'avi', 'm4v', '3gp', 'ogv', 'wmv', 'flv', 'm3u8'],
 ...
 * @returns {'image'|'video'|'audio'|'playlist'|null} Media type or null if not media
 *
 * @example
...
export function detectMediaType(url) {
  ...
  if (EXTENSIONS.playlist.includes(ext)) return 'playlist'
...
export function isPlaylist(url) {
  return detectMediaType(url) === 'playlist'
}
